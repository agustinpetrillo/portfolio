              ...
              <form>
                <div className="grid md:grid-cols-2 gap-4 w-full py-2">
                  <div className="flex flex-col">
                    ...
                    <input
                      type="text"
                      className="text-sm p-3 border-2 rounded-lg flex border-gray-300"
                ...
                <div className="flex flex-col py-2">
                  ...
                  <textarea
                    type="text"
                    className="text-sm p-3 border-2 rounded-lg flex border-gray-300 resize-none h-40"
        ...
        <div className="flex justify-center py-12">
          <Link href="/">
            <div className="rounded-full shadow-lg shadow-gray-400 p-4 cursor-pointer hover:scale-110 ease-in-out duration-200">
              <HiOutlineChevronDoubleUp size={20} className="text-[#5651e5]" />
            </div>
          </Link>
        </div>
      </Container>
