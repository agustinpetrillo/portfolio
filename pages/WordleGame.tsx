...
import en from "../translations/wordle-game/en.json";
import es from "../translations/wordle-game/es.json";
      ...
      <Container className="grid min-h-0 gap-8 px-8 py-12 text-center md:grid-cols-5 md:text-start lg:px-0">
        <div className="col-span-4">
          ...
          <div className="py-5 md:py-3">
            <a
              href="https://github.com/agustinpetrillo/wordle-game"
              target="_blank"
              rel="noreferrer"
            >
            ...
            <a
              href="https://wordle-game-react-vite.vercel.app/"
              target="_blank"
              rel="noreferrer"
            >
